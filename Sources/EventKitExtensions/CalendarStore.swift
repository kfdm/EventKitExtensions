...
extension CalendarStore {
  ...
  public func incomplete(for calendar: EKCalendar, from start: Date? = nil, to end: Date? = nil)
    async -> [EKReminder]
  {
    let predicate = store.predicateForIncompleteReminders(
      withDueDateStarting: start, ending: end, calendars: [calendar])
  ...
  /// - Returns: Return matching [EKReminder]
  public func completed(for calendar: EKCalendar, from start: Date? = nil, to end: Date? = nil)
    async
    -> [EKReminder]
  {
